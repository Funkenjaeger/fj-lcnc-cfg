...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def init_preferences(self):
        ...
        self.w.tool_change_mode_button.setChecked(self.w.PREFS_.getpref('Automatic tool change', False, bool, 'CUSTOM_FORM_ENTRIES'))
    ...
    def closing_cleanup__(self):
        ...
        self.w.PREFS_.putpref('Automatic tool change', self.w.tool_change_mode_button.isChecked(), bool, 'CUSTOM_FORM_ENTRIES')
